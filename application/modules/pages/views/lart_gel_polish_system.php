<main role="main" id="onas">
	...
	<div class="slider clearfix">
		...
		<div class="w-100 w-100-img float-left vertical slider hidden-md-down">
			...
			<div>
				...
				<img src="<?php echo base_url() ?>assets/template/frontend/img/gel-polish.png" alt="" />
			</div>
	...
	<div class="row-custom w-100 product-background" style="background-image: url('<?php echo base_url() ?>assets/template/frontend/img/lart-nais-gel.jpg');">
		...
		<div class="row-custom w-100 py-5">
			...
			<div class="col-12 col-md-4 text-center hidden-md-down">
				<img class="w-100" src="<?php echo base_url() ?>assets/template/frontend/img/hybrid-korom.png" alt="" />
				<div class="color-4 mb-3 prod-podpis"></div>
				<div>
