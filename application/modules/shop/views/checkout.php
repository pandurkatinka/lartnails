					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<div class="panel-title">
								<div class="row">
									<div class="col-lg-6">
										<h5 class='mt20'><i class='fa fa-money'></i> Fizetés - Utánvéttel</h5>
									</div>
									<div class="col-lg-6">
									...
									<div class='col-lg-12 text-center' style="border: 3px solid #e2eff5; padding-top: 50px; padding-left: 50px;">
		                                        ...
		                                        <?php
			                                        ...
			                                        if (in_array(2, $discounts)) { ?>
			                                        	<div class="col-lg-3">
			                                        		<label><input type="radio" name="Kedvezmény" value="20 százalék mínusz a BC230 készülékekből"><a id="kedvezmeny" class="fancybox" href="http://babycontrol.hu/assets/uploads/files/05e6e-1.jpg"><img width="150" style="margin-right:12px" src="http://babycontrol.hu/assets/uploads/files/05e6e-1.jpg"></a></label>
			                                        	</div>
			                                        <?php }
			                                        if (in_array(1, $discounts) || in_array(2, $discounts)) { ?>
				                                        <div class="col-lg-3">
					                                        	<label><input type="radio" name="Kedvezmény" value="Ajándék érzékelőlap"><a id="kedvezmeny" class="fancybox" href="http://babycontrol.hu/assets/uploads/files/a6782-3.jpg"><img width="150" style="margin-right:12px" src="http://babycontrol.hu/assets/uploads/files/a6782-3.jpg"></a></label>
					                                    </div>
				                                    <?php }
			                                        if($discountstotal > 1){ ?>
			                                        	<div class="col-lg-3">
				                                        	<label><input type="radio" name="Kedvezmény" value="15 százalék mínusz 2 új termék vásárlása esetén"><a id="kedvezmeny" class="fancybox" href="http://babycontrol.hu/assets/uploads/files/dbc09-2.jpg"><img width="150" style="margin-right:12px" src="http://babycontrol.hu/assets/uploads/files/dbc09-2.jpg"></a></label>
				                                        </div>
			                                        <?php }
		                                        ?>
		                                        <div class="col-lg-3">
		                                        	<input type="radio" name="Kedvezmény" value="Nem választott" checked=""> <label style="margin-right:12px">Nincs</label>
		                                        </div>
