...
class MY_Loader extends MX_Loader {
    ...
    {
        //Default site data
        $this->site_set = $this->get_settings();
        $this->contact_info = $this->get_contact_info();
        $this->session->contact_info = $this->get_contact_info();
        $this->session->site_set = $this->get_settings();
