...
<body>
	...
	<form class="form-inline" id="upl" name="upl" action="<?php echo "http://" . $_SERVER['SERVER_NAME']?>/Uploader/upload/{#jbimages_dlg.lang_id}" method="post" enctype="multipart/form-data" target="upload_target" onsubmit="jbImagesDialog.inProgress();">
